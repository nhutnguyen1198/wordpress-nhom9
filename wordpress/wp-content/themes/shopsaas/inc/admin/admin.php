...
class Admin {
    ...
    public function __construct() {
        ...
        // Add admin page
        add_action('admin_menu', [$this, 'shopsaas_admin_page']);
    ...
    public function admin_script_n_style() {
        ...
        if (isset($screen->base) && $screen->base == 'toplevel_page_shopsaas-admin') {
            remove_all_actions('admin_notices');

            wp_enqueue_script('shopsaas-admin', SHOPSAAS_URI . 'js/admin.js', array('jquery'), SHOPSAAS_VERSION, array());
            ...
            wp_enqueue_style('admin-notice-styles', SHOPSAAS_URI . 'css/admin.css', array(), SHOPSAAS_VERSION);

            add_filter('admin_footer_text', [$this, 'esh_remove_admin_footer_text']);
        }
    }

    public function shopsaas_admin_page() {
        // Add top-level menu page
        $menuImg = SHOPSAAS_URI . 'images/menu-logo.svg';
        add_menu_page(
            'Shopsaas',  // Page title
            'Shopsaas',            // Menu title
            'manage_options',   // Capability required to access the page
            'shopsaas-admin',      // Menu slug
            array($this, 'shopsaas_admin_page_content'), // Callback function
            $menuImg, // Icon
            20                  // Position
        );
    }
    ...
    public function esh_remove_admin_footer_text() {
        return 'Enjoyed <span class="sh-saas-footer-thankyou"><strong>Shopsaas</strong>? Please leave us a <a href="https://wordpress.org/support/theme/shopsaas/reviews/?rate=5#new-post" target="_blank">★★★★★</a></span> rating. We really appreciate your support!';
    }

    public function shopsaas_free_features() {
        return array(
    ...
    public function shopsaas_premium_features(){
        return array(
    ...
    public function shopsaas_admin_page_content() { 
        $shopsaas_free_features = $this->shopsaas_free_features();
        $shopsaas_premium_features = $this->shopsaas_premium_features(); ?>
        ...
        <div class="page-content">
            <div class="tabbed">
                ...
                <div class="head-top-items">
                    <div class="head-item">
                        <a href="#" class="site-icon"><img src="<?php echo SHOPSAAS_URI . 'images/site-logo.png' ?>" alt=""></a>
                        <ul class="tabs">
                            <li class="tab">
                                <label for="tab1" tab="welcome">
                                <a  href="<?php echo esc_url( add_query_arg( [ 'tab'   => 'welcome'] ) ); ?>">
                                    <?php esc_html_e( 'Welcome', 'shopsaas' ); ?>
                                </a>
                                </label>
                            </li>
                            <li class="tab">
                                ...
                                <a  href="<?php echo esc_url( add_query_arg( [ 'tab'   => 'starter-sites'] ) ); ?>">
                                    <?php esc_html_e( 'Starter Sites', 'shopsaas' ); ?>
                                </a>
                                </label>
                            </li>
                            <li class="tab">
                                ...
                                <a  href="<?php echo esc_url( add_query_arg( [ 'tab'   => 'plugins'] ) ); ?>">
                                    <?php esc_html_e( 'Plugins', 'shopsaas' ); ?>
                                </a>
                                </label>
                            </li>
                        </ul>
                    ...
                    <div class="right-top-area">
                        <div class="version">
                            <span><?php echo SHOPSAAS_VERSION; ?></span>
                        </div>
                        <div class="feature_pro">
                            <a href="https://anantaddons.com/pricing/" target="_blank" title="Upgrade to Pro">
                                ...
                                <span class="head-title"><?php esc_html_e( 'Upgrade to Pro', 'shopsaas' ); ?></span>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="sh-saas-main-area">
                    <div class="tab-contents">
                        <div class="tab-content welcome">
                            <div class="item-content flex align-center gap-30">
                                <div class="text-content">
                                    <h2 class="heading-content"> 
                                        <?php esc_html_e( 'Welcome to ', 'shopsaas' ); 
                                        $current_theme = wp_get_theme();
                                        echo esc_html( $current_theme->get( 'Name' ) );                                       
                                        ?>
                                    </h2>
                                    <p><?php esc_html_e( 'Shopsaas is a sleek, fast, and highly customizable WordPress theme crafted specifically for e-commerce Business professionals. Perfect for building modern, client-focused websites, it’s lightweight, performance-optimized, and designed to showcase services, build credibility, and drive inquiries.', 'shopsaas' );?></p>
                                    <div class="buttons flex gap-15">
                                        <a href="<?php echo esc_url( add_query_arg( [ 'tab'   => 'starter-sites'] ) ); ?>" class="btn-default"><?php esc_html_e( 'Get Starter Sites', 'shopsaas' );?></a>
                                        <a href="#" class="btn-default">Watch and Launch Quickly!</a>
                                    </div>
                                </div>
                                <!-- media -->
                                <div class="shopsaas-media">
                                    <img src="<?php echo esc_url( SHOPSAAS_URI . 'images/admin-image.jpg' ); ?>" alt="Notice Image">
                                </div>
                            </div>
                            
                            <div class="grid mt-30 gap-30 column-4">
                                <div class="sh-saas-key-features col-span-3">
                                    <div class="sh-saas-key-features-free">
                                        <h2 class="sh-saas-key-feature-title">Elevate Your Business with Shopsaas Features</h2>
                                        <div class="sh-saas-key-features_content">
                                            <?php foreach ($shopsaas_free_features as $features) { ?>
                                                <div class="sh-saas-key-feature-box">
                                                    <div class="sh-saas-key-features-title-area">
                                                        <h5 class="sh-saas-key-features-title"><a href="<?php echo esc_url($features['demo']); ?>" target="_blank"><?php echo esc_html($features['name']); ?></a></h5>
                                                    </div>
                                                    <div class="sh-saas-key-features-btn-area anant-admin-f-center">
                                    ...
                                    <div class="sh-saas-key-feature-premium">
                                        <h2 class="sh-saas-key-feature-title">Unlock Your Business's Full Potential with Pro Features.</h2>
                                        <div class="sh-saas-key-features_content">
                                            <?php foreach ($shopsaas_premium_features as $features) { ?>
                                                <div class="sh-saas-key-feature-box">
                                                    <div class="sh-saas-key-features-title-area">
                                                        <h5 class="sh-saas-key-features-title"><a href="<?php echo esc_url($features['demo']); ?>" target="_blank"><?php echo esc_html($features['name']); ?></a></h5>
                                                        <?php if($features['type'] == 'pro'){ ?>
                                                            <span class="sh-saas-pro-feature">Pro</span>
                                                        <?php } ?>
                                                    </div>
                                                    <div class="sh-saas-key-features-btn-area anant-admin-f-center">
                                                        <a href="<?php echo esc_url($features['demo']); ?>" target="_blank" class="edit"><i class="dashicons dashicons-external"></i></a> 
                                            ...
                                            <!-- <div class="sh-saas-key-feature-box">
                                                <div class="sh-saas-key-features-title-area">
                                                    <h5 class="sh-saas-key-features-title"><a href="" target="_blank">Product Slider</a></h5>
                                                </div>
                                                <div class="sh-saas-key-features-btn-area anant-admin-f-center">
                                ...
                                <div class="sh-saas-quick-links">
                                    <div class="sh-saas-quick-link-box">
                                        <div class="sh-saas-item-icon-title">
                                            <h2 class="sh-saas-heading">Upgrade to Pro</h2>
                                            <span class="sh-saas-item-icon">
                                        ...
                                        <p class="sh-saas-paragraph">Unlock advanced customization and enjoy premium support from our team of WordPress wizards.</p>   
                                        <a href="https://anantaddons.com/pricing/" target="_blank" class="sh-saas-sm-link">Buy Now!</a>                             
                                    </div>

                                    <div class="sh-saas-quick-link-box">
                                        <div class="sh-saas-item-icon-title">
                                            <h2 class="sh-saas-heading">Explore the Guide</h2>
                                            <span class="sh-saas-item-icon">
                                        ...
                                        <p class="sh-saas-paragraph">Struggling to figure it out? Let our detailed guides be your ultimate problem-solver!</p>   
                                        <a href="https://anantaddons.com/docs/" target="_blank" class="sh-saas-sm-link">Explore Now</a>                             
                                    </div>

                                    <div class="sh-saas-quick-link-box">
                                        <div class="sh-saas-item-icon-title">
                                            <h2 class="sh-saas-heading">Rate Us</h2>
                                            <span class="sh-saas-item-icon">
                                        ...
                                        <a href="https://wordpress.org/support/theme/shopsaas/reviews/#new-post" target="_blank"></a>
                                        <p class="sh-saas-paragraph">Share your thoughts! Please leave a review and help us improve your experience.</p>   
                                        <a href="https://wordpress.org/support/theme/shopsaas/reviews/#new-post" target="_blank" class="sh-saas-sm-link">Submit a Review</a>                             
                                    </div>

                                    <div class="sh-saas-quick-link-box">
                                        <div class="sh-saas-item-icon-title">
                                            <h2 class="sh-saas-heading">Our support</h2>
                                            <span class="sh-saas-item-icon">
                                        ...
                                        <a href="https://wordpress.org/support/theme/shopsaas/" target="_blank"></a>
                                        <p class="sh-saas-paragraph">Need help or have feedback? Join our Support Forum for quick answers and friendly advice!</p>   
                                        <a href="https://wordpress.org/support/theme/shopsaas/" target="_blank" class="sh-saas-sm-link">Ask for Help</a>                             
                                    </div>

                                    <div class="sh-saas-quick-link-box">
                                        <div class="sh-saas-item-icon-title">
                                            <h2 class="sh-saas-heading">Feature Request</h2>
                                            <span class="sh-saas-item-icon">
                                        ...
                                        <a href="https://wordpress.org/support/theme/shopsaas/reviews/?rate=5#new-post" target="_blank"></a>
                                        <p class="sh-saas-paragraph">We’d love to hear your ideas—share any features you think could make our product even better!</p>   
                                        <a href="https://anantsites.com/support/support-ticket/" target="_blank" class="sh-saas-sm-link">Send Feedback</a>                             
                                    </div>
                            ...
                            <?php if(!$this->is_plugin_installed('ananta-sites') || !is_plugin_active($this->retrive_plugin_install_path('ananta-sites'))){ ?>
                                <div class="modal-main">
                                    <div class="modal-image overlay">
                                        <img src="<?php echo SHOPSAAS_URI . 'images/demos.jpg' ?>" alt="">
                                    </div>
                                    <div class="modal-popup">
                                        <div class="modal-popup-content">
                                            <div class="modal-icon">
                                                <img src="<?php echo SHOPSAAS_URI . 'images/anantsite-logo.png' ?>" alt="">
                                            </div>
                                            <div>
                                                <h4>Anant Sites</h4>
                                                <p>Elevate Your Shopsaasing Website Instantly with 10+ Elementor Templates from Anant Sites.</p>
                                                <a href="#" class="btn-default ins-ant-site" plug="ananta-sites" status="<?php echo $this->plugin_status_check('ananta-sites'); ?>">
                                                    <?php if (!$this->is_plugin_installed('ananta-sites')) {
                                                        esc_html_e('Install Anant Sites', 'shopsaas');
                                                    } elseif (!is_plugin_active($this->retrive_plugin_install_path('ananta-sites'))) {
                                                        esc_html_e('Activate Anant Sites', 'shopsaas');
                                                    } else {
                                                        esc_html_e( 'Import Demo', 'shopsaas' );
                                                    }
                                                    ?>
                                                </a>
                                            </div>
                                                    ...
                                                    <div class="grid-item-overlay flex items-center justify-center">
                                                        <?php if ($this->is_plugin_installed('anant-addons-for-elementor-pro') === false && strtolower($demo['meta']['plugin_type'][0]) == "pro"): ?>
                                                            <a class="demos-link" target="_blank"
                                                                ...
                                                                <?php esc_html_e('Buy Now', 'shopsaas'); ?>
                                                            </a>
                                                        <?php else: ?>
                                                            <a class="demos-link" href="<?php echo esc_url(admin_url().'admin.php?page=ananta-demo-import&step=2&editor=elementor&theme_id='.$demo['id'].'&preview_url='.esc_url($demo['meta']['preview_link'][0]));?>">
                                                                <?php esc_html_e('Import', 'shopsaas'); ?>
                                                            </a>
                                                        <?php endif; ?>
                                                        <a aria-current="page" href="<?php echo !empty($demo['meta']['preview_link'][0]) ? esc_url(admin_url().'admin.php?page=ananta-demo-import&step=preview&editor=elementor&theme_id='.$demo['id'].'&preview_url='.esc_url($demo['meta']['preview_link'][0]).'&pro_link='.esc_url($demo['meta']['pro_link'][0]).'&dtn='.esc_attr($demo['meta']['plugin_name'][0])) : '#'; ?>" class="demos-preview-link">
                                                            <?php esc_html_e('Preview', 'shopsaas'); ?>
                                                        </a>
                                                    </div>
                                                </div>
                        ...
                        <div class="tab-content plugins">
                            ...
                            <div class="grid column-4 gap-30">
                                <div class="sh-saas-quick-link-box">
                                    <div class="sh-saas-img">
                                        <img src="<?php echo SHOPSAAS_URI . 'images/anantsite-logo.png' ?>" alt="">
                                        <h2 class="sh-saas-img-heading">Anant Sites</h2>
                                    </div>
                                    <p class="sh-saas-paragraph">Anant Sites offers 40+ pre-made Elementor templates, including Woo-ready designs.</p>
                                    <a href="#" class="sh-saas-btn-link" plug="ananta-sites" status="<?php echo $this->plugin_status_check('ananta-sites'); ?>">
                                        <?php if (!$this->is_plugin_installed('ananta-sites')) {
                                                esc_html_e('Install', 'shopsaas');
                                            } elseif (!is_plugin_active($this->retrive_plugin_install_path('ananta-sites'))) {
                                                esc_html_e('Activate', 'shopsaas');
                                            } else {
                                                esc_html_e('Activated', 'shopsaas' );
                                            }
                                        ?>
                                    </a>
                                </div>
                                <div class="sh-saas-quick-link-box">
                                    <div class="sh-saas-img">
                                        <img src="<?php echo SHOPSAAS_URI . 'images/anantsite-logo.png' ?>" alt="">
                                        <h2 class="sh-saas-img-heading">Anant Addons</h2>
                                    </div>
                                    <p class="sh-saas-paragraph">Enhance your Elementor experience with 90+ essential elements and extensions.</p>
                                    <a href="#" class="sh-saas-btn-link" plug="anant-addons-for-elementor" status="<?php echo $this->plugin_status_check('anant-addons-for-elementor'); ?>">
                                ...
                                <div class="sh-saas-quick-link-box">
                                    <div class="sh-saas-img">
                                        <img src="<?php echo SHOPSAAS_URI . 'images/postextra-logo.png' ?>" alt="">
                                        <h2 class="sh-saas-img-heading">Post Extra</h2>
                                    </div>
                                    <p class="sh-saas-paragraph">Boost your content with Post Extra’s customizable Gutenberg posts blocks.</p>
                                    <a href="#" class="sh-saas-btn-link" plug="post-extra" status="<?php echo $this->plugin_status_check('post-extra'); ?>">
                                ...
                                <div class="sh-saas-quick-link-box">
                                    <div class="sh-saas-img">
                                        <img src="<?php echo SHOPSAAS_URI . 'images/gutenwawe-logo.png' ?>" alt="">
                                        <h2 class="sh-saas-img-heading">Gutenwave</h2>
                                    </div>
                                    <p class="sh-saas-paragraph">Create WordPress pages effortlessly with Gutenwave, your ultimate tool for seamless design and innovation.</p>
                                    <a href="#" class="sh-saas-btn-link" plug="gutenwave-blocks" status="<?php echo $this->plugin_status_check('gutenwave-blocks'); ?>">
    ...
    public function install_plug_ajax() {
        ...
        $plugin_status = $this->shopsaas_get_required_plugin_status($plugin, $all_wp_plugins);
    ...
    public function install_plugin($plugin = array()) {
        ...
        if (!isset($plugin['slug']) || empty($plugin['slug'])) {
            return esc_html__('Invalid plugin slug', 'shopsaas');
        }
        ...
        if (is_wp_error($result)) {
            ...
            return esc_html__('Unable to connect to the filesystem. Please confirm your credentials.', 'shopsaas');
        }

        /* translators: %s plugin name. */
        return sprintf(esc_html__('Successfully installed "%s" plugin!', 'shopsaas'), $api->name);
    }
    ...
    private function shopsaas_get_required_plugin_status($plugin, $all_plugins) {
