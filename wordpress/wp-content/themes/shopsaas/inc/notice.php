<?php class Notice {
    ...
    public function __construct() {
        ...
        add_action('admin_enqueue_scripts', array($this, 'shopsaas_admin_assests'), 999);
                        ...
                        <div class="esh-el-notice-inner">
                            <div class="esh-el-content">
                                ...
                                <div class="esh-el-details">
                                    <p><?php esc_html_e( 'Thanks for choosing the Shopsaas theme! With 80+ widgets, you can fully customize your site. Install the Anant Sites plugin to import demo content and launch your site quickly.', 'shopsaas' ); ?></p>
                                </div>
                                <div class="esh-el-notice-btn">
                                    <a class="btn notice-action url_ins" href="#">
                                        <?php if(!$this->is_plugin_installed('ananta-sites')){
                                            esc_html_e( 'Get Started with Anant Sites', 'shopsaas' );
                                    ...
                                    <!-- <a class="btn notice-action" href="https://www.youtube.com/watch?v=mf549otb_hI" target="_blank">
                                        <php esc_html_e( 'Video Tutorial', 'shopsaas' );?>
    ...
    public function shopsaas_admin_assests() {
        wp_enqueue_script('shopsaas-ins-plug', get_template_directory_uri() . '/js/init.js', array('jquery'), '', true);
        wp_localize_script('shopsaas-ins-plug',
            'ins_plug_ajax_obj', 
                array(
                    'ajax_url' => admin_url('admin-ajax.php'),
                    'nonce' => wp_create_nonce('nonce_check'),
                    'import_url' => admin_url('admin.php?page=shopsaas-admin&tab=welcome')
                )
            );
    ...
    public function install_plug_ajax() {
        ...
        $plugin_status = $this->shopsaas_get_required_plugin_status('ananta-sites', $all_wp_plugins);     
