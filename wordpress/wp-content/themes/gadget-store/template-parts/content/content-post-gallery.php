...
<div id="post-<?php the_ID(); ?>" <?php post_class('blog-item'); ?>>
    <?php
        ...
        $gadget_store_post_id = get_the_ID(); // Add this line to get the post ID
        $gadget_store_gallery_shortcode = get_post_gallery();

        if (!empty($gadget_store_gallery_shortcode)) {
            // Display the gallery
            echo '<div class="embedded-gallery">' . do_shortcode($gadget_store_gallery_shortcode) . '</div>';
        }
    ?>
