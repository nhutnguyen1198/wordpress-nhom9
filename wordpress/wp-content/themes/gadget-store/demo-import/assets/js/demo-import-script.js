...
jQuery(document).ready(function(){
    ...
    jQuery('#gadget-store-demo-setup-guid .gadget-store-setup-menu').attr("checked","checked");

    jQuery('#gadget-store-setup-menu').click(function(){
        jQuery('#gadget-store-demo-setup-guid .gadget-store-setup-menu').css("display","block");
        jQuery('#gadget-store-demo-setup-guid .gadget-store-setup-contact').css("display","none");
        jQuery('#gadget-store-demo-setup-guid .gadget-store-setup-widget').css("display","none");
        jQuery('#gadget-store-demo-setup-guid .gadget-store-setup-social-icon').css("display","none");
    });

    jQuery('#gadget-store-setup-contact').click(function(){
        jQuery('#gadget-store-demo-setup-guid .gadget-store-setup-menu').css("display","none");
        jQuery('#gadget-store-demo-setup-guid .gadget-store-setup-contact').css("display","block");
        jQuery('#gadget-store-demo-setup-guid .gadget-store-setup-widget').css("display","none");
        jQuery('#gadget-store-demo-setup-guid .gadget-store-setup-social-icon').css("display","none");
    });

    jQuery('#gadget-store-setup-widget').click(function(){
        jQuery('#gadget-store-demo-setup-guid .gadget-store-setup-menu').css("display","none");
        jQuery('#gadget-store-demo-setup-guid .gadget-store-setup-contact').css("display","none");
        jQuery('#gadget-store-demo-setup-guid .gadget-store-setup-widget').css("display","block");
        jQuery('#gadget-store-demo-setup-guid .gadget-store-setup-social-icon').css("display","none");
    });

    jQuery('#gadget-store-setup-social').click(function(){
        jQuery('#gadget-store-demo-setup-guid .gadget-store-setup-menu').css("display","none");
        jQuery('#gadget-store-demo-setup-guid .gadget-store-setup-contact').css("display","none");
        jQuery('#gadget-store-demo-setup-guid .gadget-store-setup-widget').css("display","none");
        jQuery('#gadget-store-demo-setup-guid .gadget-store-setup-social-icon').css("display","block");
    });
});